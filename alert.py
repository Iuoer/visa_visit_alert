...
trip_date = datetime(2025, 5, 13)  # What is the latest appointment you want? 
sessions_token = "https://www.ch-edoc-reservation.admin.ch/#/session?token=NcMkNMx7&locale=en-US" # Obtain this link from the email directly
